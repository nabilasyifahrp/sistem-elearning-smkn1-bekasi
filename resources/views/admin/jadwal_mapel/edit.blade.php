...
<style>
    ...
    .form-label { font-weight: 600; color: #256343; }
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="time" name="jam_selesai" class="form-control @error('jam_selesai') is-invalid @enderror"
                        min="10:00" max="17:00" value="{{ $jadwal->jam_selesai }}" required>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <select name="tipe" class="form-control @error('tipe') is-invalid @enderror" required>
                        ...
                        @foreach (['Teori', 'Tefa'] as $t)
                            <option value="{{ $t }}" {{ $jadwal->tipe == $t ? 'selected' : '' }}>{{ $t }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="tahun_ajaran" class="form-control @error('tahun_ajaran') is-invalid @enderror"
                        placeholder="Contoh: 2024/2025" value="{{ $jadwal->tahun_ajaran }}" required>
