...
<div class="container-fluid py-4">
                ...
                <div class="col-md-6">
                    ...
                    <p class="text-muted">
                        ...
                        <span class="badge" style="background-color: 
                            {{ now() > $tugas->deadline ? '#dc3545' : '#28a745' }};">
                            {{ now() > $tugas->deadline ? 'Sudah Lewat' : $tugas->deadline->diffForHumans() }}
                        </span>
                    </p>
                </div>
                <div class="col-md-6">
                    ...
                    @if($pengumpulan)
                        ...
                        @else
                            <span class="badge" style="background-color: #ffc107; font-size: 14px;">
                                Sudah Dikumpulkan, Menunggu Penilaian
                            </span>
                        @endif
                    @else
                        <span class="badge" style="background-color: #6c757d; font-size: 14px;">
                            Belum Dikumpulkan
                        </span>
                    @endif
                </div>
    ...
    @if($pengumpulan)
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                <p><strong>Tanggal Pengumpulan:</strong> {{ $pengumpulan->tanggal_pengumpulan->format('d M Y H:i') }}</p>
                <p><strong>Status:</strong> 
                    <span class="badge" style="background-color: 
                        {{ $pengumpulan->status === 'Terlambat' ? '#dc3545' : '#28a745' }};">
                        {{ $pengumpulan->status }}
                    </span>
                </p>
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('siswa.tugas.kumpul', $tugas->id_tugas) }}" 
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">Isi Tugas <span class="text-danger">*</span></label>
                        <textarea name="isi_tugas" 
                                  class="form-control @error('isi_tugas') is-invalid @enderror" 
                                  rows="6" 
                        ...
                        <small class="text-muted">
                            Jelaskan jawaban tugas Anda dengan lengkap dan jelas
                        </small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <small class="text-muted">
                            Format: PDF, DOC, DOCX, JPG, PNG, ZIP (Max: 5MB)
                        </small>
                    </div>
                    ...
                    @if(now() > $tugas->deadline)
                        <div class="alert alert-warning">
                            ...
                            Tugas akan ditandai sebagai "Terlambat".
                        </div>
                    @endif
