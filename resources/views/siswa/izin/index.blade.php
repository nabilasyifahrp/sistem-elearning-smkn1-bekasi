...
<div class="container-fluid py-4">
    <div class="row mb-4">
        ...
        <div class="col-md-4 text-end">
            <a href="{{ route('siswa.izin.create') }}" class="btn text-white" style="background-color: #256343;">
    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="text-center py-5">
                ...
                <a href="{{ route('siswa.izin.create') }}" class="btn btn-sm text-white"
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><small>{{ Str::limit($izin->alasan, 50) }}</small></td>

                            <td>
                                @if ($izin->bukti_file)
                                <a href="{{ asset('storage/' . $izin->bukti_file) }}" target="_blank"
                            ...
                            <td>
                                ...
                                <form action="{{ route('siswa.izin.batalkan', $izin->id_pengajuan) }}"
                                    method="POST"
